 ...
 *
 *   The QR is **not drawn by the page**. `npm run qr` renders it from
 ...
 *
 *   Re-run `npm run qr` after changing this value, or the committed
...
/**
 * The public address of the app, and what `public/share-qr.svg` encodes.
 *
 * Kept here rather than inlined so the QR generator and the UI cannot disagree
 * about where a scan leads.
 */
export const SITE_URL = "https://metro.itstom.me";

/** The share QR for {@link SITE_URL}, generated by `npm run qr`. */
export const SHARE_QR_SRC = "/share-qr.svg";
