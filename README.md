...
| [![About and support](docs/media/09-about-support.png)](docs/media/09-about-support.png)<br>**About.** Data provenance, the privacy position, and an entirely optional way to chip in. | [![Thai on a phone](docs/media/10-phone-map-thai.png)](docs/media/10-phone-map-thai.png) [![Search on a phone](docs/media/11-phone-search-thai.png)](docs/media/11-phone-search-thai.png)<br>**On a phone, in Thai.** The line panel collapses, the planner becomes a sheet. |
